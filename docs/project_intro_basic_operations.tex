...
\code{python main.py plot-xrd} renders raw or normalized XRD scans, supports selected
samples and optional PDF-card stick patterns, and writes figures under
...
python main.py plot-xrd CHY-1038-A --mode normalized --no-show
